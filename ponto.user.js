...
(function() {
    ...
    style.innerHTML = `
        ...
        #ic-header {
            background: #212121 !important; padding: 12px 15px !important;
            cursor: move !important; display: flex !important;
            justify-content: space-between !important; align-items: center !important;
            height: 35px; border-radius: 14px 14px 0 0;
        ...
        .pro-input {
            width: 100% !important; padding: 10px !important; background: var(--ic-input-bg) !important;
            border: 1px solid #3d3d3d !important; border-radius: 8px !important; color: #fff !important;
            font-size: 13px !important; margin-bottom: 12px !important; box-sizing: border-box !important;
        ...
        .btn-main {
            background: #2980b9 !important; color: white !important; border: none !important;
            padding: 12px !important; width: 100% !important; border-radius: 8px !important;
