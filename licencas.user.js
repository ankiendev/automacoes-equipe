// ==UserScript==
// @name         Gerador de Payload - v3.5 Final Performance
// @namespace    http://tampermonkey.net/
// @version      3.5
// @description  Visibilidade estrita (só condomínios), arraste sem lag e cores Kiper.
// @author       Gemini AI
...
(function() {
    ...
    function syncAll() {
        ...
        if (!isCondo) {
            ...
            return; // Mata o loop aqui se não estiver no condomínio
        }

        // Se for condomínio, define se exibe pílula (flex) ou painel (block)
        ...
        if (idMatch && document.activeElement !== document.getElementById('rpa-personId')) {
            document.getElementById('rpa-personId').value = idMatch[1];
        }
