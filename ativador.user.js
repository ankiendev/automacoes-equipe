...
// @require      https://raw.githubusercontent.com/ankiendev/automacoes-equipe/main/condominio.user.js?v=3
...
// Lógica de filtro para carregar o script de condomínio apenas na página correta
if (window.location.href.includes('monitoring.cloud.kiper.com.br/condominiums')) {
    if (typeof carregarCondominio === 'function') {
        carregarCondominio();
    }
}
